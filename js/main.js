  ...
  return new Promise((resolve, reject) => {
    ...
    s.onload = () => {
      ...
      const indexKeysEn = {
        ...
        'quote.weight.label': 'Package Weight (add kg, e.g. 50kg)',
        'quote.weight.placeholder': 'e.g. 50kg',
      ...
      const indexKeysDa = {
        ...
        'quote.weight.label': 'Pakkens vægt (tilføj kg, f.eks. 50kg)',
        'quote.weight.placeholder': 'f.eks. 50kg',
      ...
      ,
        ...
        'pricing.card1.title': 'Én mand & varebil',
        ...
        'pricing.card2.title': 'To mænd & varebil',
        ...
        'pricing.card3.title': 'Tre mænd & varebil',
